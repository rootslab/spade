...
exports.Spade = ( function () {
    ...
    /*
     * Initialize LUA script cache, loading and sending all the
     * files found in the './node_modules/syllabus/lib/lua/scripts'
     * directory, to rhe Redis Server.
     *
     * NOTE:
     *  Empty files and also the scripts that will be refused by Redis
     *  ( an error reply has been received ), are automatically removed
     *  from the cache.
     *
     * NOTE:
     ...
     *  - to get the current cache object/hash, use
     *     Spade.lua.cache();
     *
     *  See also Syllabus.lua : https://github.com/rootslab/syllabus
     */
    sproto.loadScriptCache = function () {
        var me = this
            , lua = me.lua
            , libra = me.queue
            , cocker = me.socket
        ...
        }, function ( script, data, txt ) {
            me.emit( 'scriptloaded', script, data, txt );
        } );
    };
