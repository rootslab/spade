...
exports.Spade = ( function () {
    ...
    sproto.initCache = function ( file_load_opt, cache_init_opt ) {
         ...
         *
         * NOTE: if 'cache_init_opt' is set, cache will be
         * re-initialized; it happens only if the cache is
         * ready, or when no other script commands are already
         * been queued and not yet been sent to Redis.
         */
        ...
        // pass file loading and cache options
