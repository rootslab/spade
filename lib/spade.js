/*
 * ♠ Spade, a robust, full-featured, multi-modular Redis client, with offline
 * queue for commands, automatic socket reconnection and command rollback
 * mechanism for subscriptions, moreover, it supports caching for LUA scripts.
 *
...
exports.Spade = ( function () {
    var emitter = require( 'events' ).EventEmitter
        ...
        , Spade = function ( opt ) {
                ...
                , onParserMatch = function ( err_reply, data, fn ) {
                    ...
                    var cmd = null
                        ...
                        , getReplyMessages = function ( err_reply ) {
                            ...
                            if ( cmd.pn ) cmd.pn.rs( [ err_reply, data, cmd.fn ] );
                            else cmd.zn( err_reply, data, cmd.fn );
            ...
            syllabus.wrap( send, cfg.promisify );
            // wrap syllabus lua scripts/commands
            syllabus.lua.wrap( send, cfg.promisify );
