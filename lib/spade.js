/*
 * ♠ Spade, a full-featured, multi-modular Redis client, with offline queue
        ...
        , Spade = function ( opt ) {
            ...
            var cfg = improve( clone( opt ), spade_opt )
                ...
                , onParserMatch = function ( err_reply, data, fn ) {
                    ...
                    return ! cmd ? onParserError( new Error( emsg_unexp ), fn( data ) ) :
                ...
                , send = function ( ocmd ) {
                    ...
                    // push commanfonPad to the queue, if no error occurs.
