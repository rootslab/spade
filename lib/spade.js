 ...
 * mechanism for subscriptions and incomplete transactions, caching
 * for LUA scripts.
 *
...
exports.Spade = ( function () {
    ...
    sproto.initCache = function ( opt, reset ) {
        var me = this
            , lua = me.lua
            , libra = me.queue
            , cocker = me.socket
            ;
        /*
         * When the client is offline and the cache is
         * already loading scripts, return to avoid
         * enqueuing of multiple SCRIPT LOAD commands.
         */
         ...
         */
        me.cacheready = false;
        // clear cache before initializing it, if reset is true
        if ( reset ) lua.cache().clear();
